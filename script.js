...
function atualizaInterface(){
    ...
    let candidato = etapa.candidatos.filter((item)=>{
        ...
        if(candidato.length > 0){
            ...
            seuVotoPara.style.display = 'block';
            aviso.style.display = 'block';
            descricao.innerHTML = '<div class="avisa--grande pisca">VOTO NULO</div>';
        }
}
...
function branco(){
    ...
    aviso.style.display = 'block';
    numeros.innerHTML = '';
    descricao.innerHTML = '<div class="avisa--grande pisca">VOTO EM BRANCO</div>';
    lateral.innerHTML = '';
}
function corrige(){
    comecarEtapa();
...
function confirma(){
    ...
    if(votoConfirmado){
        ...
        if(etapas[etapaAtual] !== undefined){
            ...
            document.querySelector('.tela').innerHTML = '<div class="avisa--gigante pisca">FIM</div>';
            console.log(votos);
        }
